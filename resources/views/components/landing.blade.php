    ...
    <div class="container">
        <section class="hero">
            <div class="hero-text">
                ...
                <p>Nikmati kemudahan dalam memesan lapangan futsal berkualitas tinggi. Praktis, cepat, dan terpercaya
                    untuk semua kebutuhan olahraga Anda.</p>

                <div class="button-group">
                    <a href="public/register.php" class="btn">Register Sekarang</a>
                    <a href="public/login.php" class="btn secondary">Login & Booking</a>
                </div>
            </div>
        ...
        <section class="courts-section">
            <div class="section-title">
                ...
                <p>Lapangan berkualitas premium dengan fasilitas terbaik untuk pengalaman bermain yang tak terlupakan
                </p>
            </div>
            ...
            <div class="courts-grid">
                <div class="court-card">
                    <div class="court-image">
                        <div class="image-slider">
                            <div class="slider-container">
                                <?php if (!empty($lapFotos)): ?>
                                <?php foreach ($lapFotos as $foto): ?>
                                <div class="slide">
                                    <img src="uploads/<?= $foto ?>" alt="<?= $lap['nama_lapangan'] ?>"
                            ...
                            <div class="slider-dots">
                                <?php
                                    $totalSlides = !empty($lapFotos) ? count($lapFotos) : 1;
                    ...
                    <div class="court-info">
                        <h3 class="court-name"><?= $lap['nama_lapangan'] ?></h3>
                        <div class="court-price">
                            <div>
                                <span class="price">Rp <?= number_format($lap['harga_normal'], 2, ',', '.') ?></span>
                                <span class="price-per">/jam</span>
                            </div>
                        </div>
                        <a class="book-btn" style="text-decoration: none;"
                            href="public/booking.php?lapangan=<?= $lap['id'] ?>">Booking Sekarang</a>
                    </div>
                </div>
                <?php endwhile; ?>
            </div>
